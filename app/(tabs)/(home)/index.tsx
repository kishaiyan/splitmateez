...
const Home = () => {
  ...
  const { userDetails, properties, isLoading } = state;
      ...
      <>
        <View className='h-[10%] flex-row justify-between'>
          ...
          <View>
            ...
            >
              {
                isLoading ? null : <Text className='text-secondary text-2xl font-extrabold'>
        ...
        >
          {
            isLoading ? null : <View className='h-[80%] items-center'>

      ...
      {codesent &&
        <View className='items-center'>
          ...
          <View className='flex-col items-center'>
            <TextField label="Code" value={passform.code} onhandleChange={(e) => setPassForm({ ...passform, code: e })} placeholder="secret code" keyboardtype="numeric" secureTextEntry={false} />
            <TextField label="Password" value={passform.password} onhandleChange={(e) => setPassForm({ ...passform, password: e })} placeholder="" keyboardtype="normal" secureTextEntry={false} />
